...
var Navbar = React14.forwardRef((props, ref) => {
  const {
  ...
  return (0, import_jsx_runtime18.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime18.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime18.jsx)(Component, {
        ref,
        ...controlledProps,
        className: (0, import_classnames8.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
//# sourceMappingURL=chunk-HFFKPTFN.js.map
